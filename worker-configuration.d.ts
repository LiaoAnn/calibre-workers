/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a932fb04d9e9bca96477a92424ca8867)
// Runtime types generated with workerd@1.20260301.1 2025-09-02 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ConverterContainer";
	}
	interface Env {
		BOOKS_STORAGE: R2Bucket;
		DB: D1Database;
		...
		CONVERTER: DurableObjectNamespace<import("./src/index").ConverterContainer>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_URL" | "BETTER_AUTH_SECRET" | "MIGRATION_SECRET">> {}
}
